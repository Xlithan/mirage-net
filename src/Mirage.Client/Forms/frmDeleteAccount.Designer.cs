namespace Mirage.Forms
{
	partial class frmDeleteAccount
	{
        ...
        private void InitializeComponent()
        {
            ...
            picDeleteAccount.Location = new Point(216, 8);
            ...
            Label2.TabIndex = 5;
            Label2.Text = "Enter a account name and password of the account you wish to delete.";
            // 
            // Label1
            // 
            ...
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "frmDeleteAccount";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Mirage Online (Delete Account)";
